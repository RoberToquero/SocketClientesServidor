...
public class ControllerC implements Initializable, Observer {
...
// Inicializa y arranca el servidor
    ...
    void enviar(ActionEvent event) {
        ...
        if(nombre.isEmpty() || mensaje.isEmpty() || mensajeAEnviar.isEmpty()){
            ...
            conversacion.registrarConversacionC(mensajeAEnviar);

            // Envía el mensaje al servidor
            Cliente cliente = new Cliente(5000, mensajeAEnviar);
            Thread hilo = new Thread(cliente);
            hilo.start();
            Cliente cliente2 = new Cliente(6000, mensajeAEnviar);
