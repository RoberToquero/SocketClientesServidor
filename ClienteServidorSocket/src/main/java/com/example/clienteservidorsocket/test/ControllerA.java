...
public class ControllerA implements Initializable, Observer {
    ...
    void enviar(ActionEvent event) {
        ...
        if(nombre.isEmpty() || mensaje.isEmpty()){
            ...
            conversacion.registrarConversacionA(mensajeAEnviar);


            // Envía el mensaje al servidor
            Cliente cliente = new Cliente(6000, mensajeAEnviar);
